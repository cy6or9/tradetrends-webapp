              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/95">
                    <TableHead
                      className="sticky left-0 top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/95 border-r border-border w-[120px]"
                    >
                    ...
                    <TableHead className="sticky top-0 z-40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/95 w-[300px]">
              ...
              <Table>
                <TableBody>
                  {sortedStocks.map((stock) => (
                    ...
                    >
                      <TableCell
                        className="sticky left-0 z-30 bg-background border-r border-border w-[120px]"
                      >
