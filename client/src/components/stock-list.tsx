...
export function StockList({ filters, setStocks }: StockListProps) {
  ...
  const handleToggleFavorite = useCallback(async (symbol: string) => {
    try {
      ...
      // If we were showing favorites, stay there
            ...
            <div className="min-w-[800px]">
              <Table>
                <TableHeader className="sticky top-0 z-50 bg-background">
                  <TableRow>
                    <TableHead className="sticky left-0 z-50 bg-background border-r border-border w-[120px]">
                    ...
                    <TableHead className="z-40 bg-background w-[300px]">
                      <Button variant="ghost" onClick={() => handleSort('name')} className="h-12 text-left font-medium w-full justify-between">
                        Name <ArrowUpDown className="h-4 w-4" />
                      </Button>
                    </TableHead>
                    <TableHead className="z-40 bg-background border-b border-border w-[100px]">
                    ...
                    <TableHead className="z-40 bg-background border-b border-border w-[110px]">
                      <div className="text-right">
                    ...
                    <TableHead className="z-40 bg-background border-b border-border w-[120px]">
